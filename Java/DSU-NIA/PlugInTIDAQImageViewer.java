...
public class PlugInTIDAQImageViewer extends ViewJFrameImage implements MouseListener, AdjustmentListener, ChangeListener
{
...
//	private ViewJFrameImage imageFrame = null;
	...
	public PlugInTIDAQImageViewer(ModelImage imageA) {
		super(imageA);
	...
	public PlugInTIDAQImageViewer(ModelImage imageA, ModelImage imageB) {
		super(imageA);
	...
	public PlugInTIDAQImageViewer openFrame(ModelImage image) {
		return new PlugInTIDAQImageViewer(image);
	}
